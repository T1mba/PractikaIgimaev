...
4.  По прибытию на место прохождения практики студент должен представить
...
5.  Во время прохождения практики студент обязан:
...
6. В отчетных документах отражаются следующие моменты:
...
7. При оценке практики принимается во внимание:
